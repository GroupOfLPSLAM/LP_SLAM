...
void Viewer::Run()
{
    ...
    text_font = new pangolin::GlFont("./lp/tff/Barlow-BlackItalic.ttf", 50.0);
    ...
    while(1)
    {
        ...
        int label_num = 0;
        while (label_num < TextMap.size()){
        if (TextMap[label_num].is_shop)      glColor3f(0.0,0.0,1.0);
            else glColor3f(0.0,1.0,0.0);
        text_font->Text(TextMap[label_num].pangolin_name.c_str()).Draw((float)TextMap[label_num].ave_pos(0), (float)TextMap[label_num].ave_pos(1), (float)TextMap[label_num].ave_pos(2));
            label_num ++;
        } /*
        if (!CombMap.empty()){
            glLineWidth(1);
            ...
            for (int i = 0; i < CombMap.size(); i++){
                ...
                glVertex3d(CombMap[i].vertex[0](0), CombMap[i].vertex[0](1), CombMap[i].vertex[0](2));
                glVertex3d(CombMap[i].vertex[1](0), CombMap[i].vertex[1](1), CombMap[i].vertex[1](2));
                glColor3f(0.0,0.0,1.0);
                glVertex3d(CombMap[i].vertex[2](0), CombMap[i].vertex[2](1), CombMap[i].vertex[2](2));
                glVertex3d(CombMap[i].vertex[1](0), CombMap[i].vertex[1](1), CombMap[i].vertex[1](2));
                glColor3f(0.0,0.0,1.0);
                glVertex3d(CombMap[i].vertex[0](0), CombMap[i].vertex[0](1), CombMap[i].vertex[0](2));
                glVertex3d(CombMap[i].vertex[2](0), CombMap[i].vertex[2](1), CombMap[i].vertex[2](2));
                glColor3f(0.0,0.0,1.0);
                glVertex3d(CombMap[i].vertex[0](0), CombMap[i].vertex[0](1), CombMap[i].vertex[0](2));
                glVertex3d(CombMap[i].vertex[3](0), CombMap[i].vertex[3](1), CombMap[i].vertex[3](2));
                glColor3f(0.0,0.0,1.0);
                glVertex3d(CombMap[i].vertex[1](0), CombMap[i].vertex[1](1), CombMap[i].vertex[1](2));
                glVertex3d(CombMap[i].vertex[3](0), CombMap[i].vertex[3](1), CombMap[i].vertex[3](2));
                glColor3f(0.0,0.0,1.0);
                glVertex3d(CombMap[i].vertex[2](0), CombMap[i].vertex[2](1), CombMap[i].vertex[2](2));
                glVertex3d(CombMap[i].vertex[3](0), CombMap[i].vertex[3](1), CombMap[i].vertex[3](2));
                Eigen::Vector3d normal = CombMap[i].vertex[0] + CombMap[i].plane;
                glColor3f(0.0,0.0,1.0);
                glVertex3d(CombMap[i].vertex[0](0), CombMap[i].vertex[0](1), CombMap[i].vertex[0](2));
